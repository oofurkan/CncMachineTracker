...
Set-Location "..\CncMachineTracker.Api.Clean"
dotnet build

Write-Host "`n🎯 Starting applications..." -ForegroundColor Yellow
Write-Host "API will be available at: http://localhost:5217" -ForegroundColor Cyan
Write-Host "React app will be available at: http://localhost:3000" -ForegroundColor Cyan
Write-Host "Swagger UI will be available at: http://localhost:5217/swagger" -ForegroundColor Cyan

Write-Host "`n⏳ Starting API in background..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'CncMachineTracker.Api.Clean'; dotnet run"
